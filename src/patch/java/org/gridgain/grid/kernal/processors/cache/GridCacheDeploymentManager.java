...
public class GridCacheDeploymentManager<K, V> extends GridCacheManagerAdapter<K, V> {
    ...
    public void registerClass(Class<?> cls, ClassLoader ldr) throws GridException {
        ...
        /**
    	 * create reason : Don't register JDK class loader
    	 * create time : 2014-12-12
    	 * create by : WangWei
    	 */
        if (cls.getClass().getClassLoader() == null //BootStrapClassLoader
        		|| cls.getClass().getClassLoader().getParent() == null //ExtClassLoader
        		|| cls.getClass().getClassLoader().getParent() == null)//AppClassLoader
        	return;
