    ...
    private static ClassLoader detectClassLoader(Class<?> cls) {
        ...
        if (ctxClsLdr != null) {
            ...
            try {
                ...
                if (c == cls)
                	/**
                	 * old version code: return ctxClsLdr;
                	 * update reason:    JDK class should not loaded by GridUriDeploymentClassLoader
                	 * update time:      2014-12-12
                	 * update by:        WangWei
                	 */
                    return cls.getClassLoader() == null ? ClassLoader.getSystemClassLoader() : ctxClsLdr;
            }
